...
use App\Http\Resources\Contract\ContractPlusData\ContractSprotelloResource;
use App\Http\Resources\Contract\Service\LavorazioneSecFourResource;
...
class LavorazioneSecFourController extends Controller
{
    ...
    public function allcontractsportello(Request $req)
    {
        ...
        return response()->json(
            ContractSprotelloResource::collection($allContractSportello)
        , 200);
    ...
    public function edit(Request $req)
    {
        ...
        return response()->json(
            new LavorazioneSecFourResource($contractSportello)
        , 200);
