...
class SelectController extends Controller
{
    ...
    public function clientServices(Request $req){
        return $this->selectService->getClientServices($req->clientId);
    }

    
    public function urbaniaClients(){
        return $this->selectService->getUrbaniaClientSelect();
    }
