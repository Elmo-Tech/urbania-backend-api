...
class CreateAiClientOuterTicketRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'status' => 'required',
            'serviceName' => 'nullable|string', // was id
            'istanzaParameterName' => 'nullable|string', // was id
            'clientName' => 'required|string', // was id
            'delegatedRoleName' => 'nullable|string', // was id
        ];
